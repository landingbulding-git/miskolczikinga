    ...
    <section className="bg-cream-100 py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className=”space-y-24 md:space-y-32”>
          ...
          {/* Pillar 1: Metodika (moved to first) */}
          <div className=”flex flex-col lg:flex-row gap-12 lg:gap-24 items-center”>
            ...
            >
              <div className=”space-y-3”>
                <span className=”text-[11px] font-bold text-gold-500 uppercase tracking-luxury block”>Metodika</span>
          ...
          {/* Pillar 2: Material Security - Anyagellátás */}
          <div className=”flex flex-col lg:flex-row gap-12 lg:gap-24 items-center”>
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className=”flex flex-col lg:flex-row-reverse gap-12 lg:gap-24 items-center”>
            ...
            >
              <div className=”space-y-3”>
                <span className=”text-[11px] font-bold text-gold-500 uppercase tracking-luxury block”>Portfólió</span>
                <h3 className=”font-serif-lux text-3xl sm:text-4xl font-bold text-charcoal-800 leading-tight” style={{ fontStyle: 'normal' }}>
